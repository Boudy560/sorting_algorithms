 ...
 */
int get_card_position(de_no_tT *node)
{
	int value;
 ...
 */
de_no_tT *swap_card(de_no_tT *card, de_no_tT **deck)
{
	de_no_tT *back = card->prev, *current = card;
 ...
 */
void insertion_sort_deck(de_no_tT **deck)
{
